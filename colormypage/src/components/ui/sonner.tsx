...
const Toaster = ({ ...props }: ToasterProps) => {
  ...
  return (
    <Sonner
      ...
      toastOptions={{
        className:
          "flex items-center gap-3 px-4 py-3 text-lg font-semibold bg-[#9d84ff]/20 backdrop-blur-sm hover:bg-[#9d84ff]/30 border border-[#9d84ff]/30 text-[#9d84ff] hover:text-white rounded-xl transition-all duration-200 shadow-md hover:shadow-lg h-auto justify-start cursor-pointer [&>[data-description]]:text-white/90 [&>[data-description]]:font-normal [&>[data-description]]:text-base",
      }}
      style={
        {
          ...
          "--toast-description-color": "#ffffff",
